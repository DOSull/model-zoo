...
586
637
This generates approximately self-similar splodges.  The size of each circle is a random deviate from a power-law with exponent alpha.  Select a patch and zoom in and out to see the self-similar effect.  Idea from Malamud (2004).
12
0.0
1
