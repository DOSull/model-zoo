...
to setup
  ...
  set perimeter-set patches with [(occupied? = false) and (count neighbors4 with [occupied? = true] >= 1) ]  
  ask patches with [occupied? = false] [set pcolor red]
  reset-ticks
end
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plotxy ticks p-length"
