...
turtles-own [ 
  real-x ; keep track of the real x coordinate not the xcor 
]
  
;patches-own [ 
;  patches-below ;; the 3 patches below this one
;]
...
1086
375
Note that the lattice discretisies the log-normal distribution that emerges from the multiplicative process - plot the data in R to get a better sense of the process.
11
0.0
1
