...
**Cauchy distributed step length** is the same as the simple case, except that the step length is chosen from a Cauchy distribution.  This produces a Levy walk with heavy-tailed step length distribution.
