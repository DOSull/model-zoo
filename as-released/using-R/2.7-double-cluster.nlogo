...
to colour-by-type
  ...
  [
    if component = "parent" [ 
      set size 2
       set color red ]
    if component = "offspring-1" [set size 1.2
       set color orange ]  
...
194
264
N.B. displacements are scaled to the unit square, not Netlogo world dimensions
9
15.0
1
...
206
249
SD of displacement for first (-g1) and second (-g2) generation offspring
11
15.0
1
...
868
196
identify parents and g1 and g2 offspring as red (larger),  orange (smaller) and yellow (smallest), respectively
11
0.0
1
...
This model simulates an point process following the 'double cluster' process and is discussed in Chapter 2 of

+   O'Sullivan D and Perry GLW 2013 _Spatial Simulation: Exploring Pattern and Process_. Wiley, Chichester, England.


You should consult that book for more information and details of the model.  The original process is described in:

+   Wiegand, T., Gunatilleke, S., Gunatilleke, N. & Okuda, T. 2007. Analyzing the spatial structure of a Sri Lankan tree species with multiple scales of clustering. _Ecology_, 88, 3088–3102.
